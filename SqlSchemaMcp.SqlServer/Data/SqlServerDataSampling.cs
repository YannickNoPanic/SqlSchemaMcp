...
public sealed class SqlServerDataSampling(IOptions<SqlServerEngineOptions> options, ILogger<SqlServerDataSampling> logger)
    : SqlQueryBase(options, logger), IDataSamplingCapability
{
