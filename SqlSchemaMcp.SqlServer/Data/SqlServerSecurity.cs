...
public sealed class SqlServerSecurity(IOptions<SqlServerEngineOptions> options, ILogger<SqlServerSecurity> logger)
    : SqlQueryBase(options, logger), ISqlServerSecurityCapability
{
