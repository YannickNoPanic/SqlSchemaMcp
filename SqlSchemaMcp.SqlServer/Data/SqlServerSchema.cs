...
public sealed class SqlServerSchema(IOptions<SqlServerEngineOptions> options, ILogger<SqlServerSchema> logger)
    : SqlQueryBase(options, logger), ISchemaCapability
{
