...
public sealed class SqlServerPipeline(IOptions<SqlServerEngineOptions> options, ILogger<SqlServerPipeline> logger)
    : SqlQueryBase(options, logger), ISqlServerPipelineCapability
{
