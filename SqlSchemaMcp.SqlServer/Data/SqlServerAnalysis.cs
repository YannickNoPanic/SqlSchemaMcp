...
public sealed class SqlServerAnalysis(IOptions<SqlServerEngineOptions> options, ILogger<SqlServerAnalysis> logger)
    : SqlQueryBase(options, logger), ISqlServerAnalysisCapability
{
