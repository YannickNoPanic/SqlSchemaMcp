...
public sealed class SqlServerDiagnostics(IOptions<SqlServerEngineOptions> options, ILogger<SqlServerDiagnostics> logger)
    : SqlQueryBase(options, logger), ISqlServerDiagnosticsCapability
{
