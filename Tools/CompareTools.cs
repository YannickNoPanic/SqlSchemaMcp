...
public sealed class CompareTools(CompareQueries queries, IAuditLog audit)
{
    ...
    public Task<string> CompareProcs(
        [Description("First database name")] string database1,
        [Description("Second database name")] string database2,
        CancellationToken cancellationToken = default) =>
        audit.Invoke(nameof(CompareProcs), $"{database1} vs {database2}", $"database1={database1}; database2={database2}",
            async () =>
            {
    ...
    public Task<string> CompareTable(
        [Description("First database name")] string database1,
        [Description("Second database name")] string database2,
        [Description("Table name to compare (e.g. 'Organisations' or 'dbo.Organisations')")] string tableName,
        CancellationToken cancellationToken = default) =>
        audit.Invoke(nameof(CompareTable), $"{database1} vs {database2}", $"tableName={AuditSummary.Truncate(tableName)}",
            async () =>
            {
    ...
    public Task<string> CompareViews(
        [Description("First database name")] string database1,
        [Description("Second database name")] string database2,
        CancellationToken cancellationToken = default) =>
        audit.Invoke(nameof(CompareViews), $"{database1} vs {database2}", $"database1={database1}; database2={database2}",
            async () =>
            {
    ...
    public Task<string> CompareView(
        [Description("First database name")] string database1,
        [Description("Second database name")] string database2,
        [Description("View name to compare")] string viewName,
        CancellationToken cancellationToken = default) =>
        audit.Invoke(nameof(CompareView), $"{database1} vs {database2}", $"viewName={AuditSummary.Truncate(viewName)}",
            async () =>
            {
    ...
    public Task<string> CompareProc(
        [Description("First database name")] string database1,
        [Description("Second database name")] string database2,
        [Description("Stored procedure name to compare")] string procName,
        CancellationToken cancellationToken = default) =>
        audit.Invoke(nameof(CompareProc), $"{database1} vs {database2}", $"procName={AuditSummary.Truncate(procName)}",
            async () =>
            {
