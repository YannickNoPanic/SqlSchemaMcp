...
[McpServerToolType]
public sealed class DiagnosticsTools(DiagnosticsQueries queries, IAuditLog audit)
{
    ...
    public Task<string> ListAgentJobs(
        [Description("Name of the configured database (used to resolve the server connection)")] string database,
        CancellationToken cancellationToken = default) =>
        audit.Invoke(nameof(ListAgentJobs), database, "",
            () => queries.ListAgentJobs(database, cancellationToken));
    ...
    public Task<string> GetFailingJobs(
        [Description("Name of the configured database (used to resolve the server connection)")] string database,
        CancellationToken cancellationToken = default) =>
        audit.Invoke(nameof(GetFailingJobs), database, "",
            () => queries.GetFailingJobs(database, cancellationToken));
    ...
    public Task<string> GetJobHistory(
        [Description("Name of the configured database (used to resolve the server connection)")] string database,
        ...
        CancellationToken cancellationToken = default) =>
        audit.Invoke(nameof(GetJobHistory), database, $"jobName={AuditSummary.Truncate(jobName)}; lastN={lastN}",
            () => queries.GetJobHistory(database, jobName, lastN, cancellationToken));
    ...
    public Task<string> AnalyzeTopExpensiveQueries(
        [Description("Name of the configured database")] string database,
        [Description("Number of queries to return (default 20)")] int top = 20,
        CancellationToken cancellationToken = default) =>
        audit.Invoke(nameof(AnalyzeTopExpensiveQueries), database, $"top={top}",
            () => queries.AnalyzeTopExpensiveQueries(database, top, cancellationToken));
    ...
    public Task<string> AnalyzeWaitStats(
        [Description("Name of the configured database (used to resolve the server connection)")] string database,
        CancellationToken cancellationToken = default) =>
        audit.Invoke(nameof(AnalyzeWaitStats), database, "",
            () => queries.AnalyzeWaitStats(database, cancellationToken));
    ...
    public Task<string> ListLinkedServers(
        [Description("Name of the configured database (used to resolve the server connection)")] string database,
        CancellationToken cancellationToken = default) =>
        audit.Invoke(nameof(ListLinkedServers), database, "",
            () => queries.ListLinkedServers(database, cancellationToken));
    ...
    public Task<string> FindLinkedServerUsage(
        [Description("Name of the configured database")] string database,
        ...
        CancellationToken cancellationToken = default) =>
        audit.Invoke(nameof(FindLinkedServerUsage), database, $"linkedServerName={AuditSummary.Truncate(linkedServerName)}",
            () => queries.FindLinkedServerUsage(database, linkedServerName, cancellationToken));

    [McpServerTool, Description("List all user-defined Service Broker queues and services in the specified database.")]
    public Task<string> ListServiceBroker(
        [Description("Name of the configured database")] string database,
        CancellationToken cancellationToken = default) =>
        audit.Invoke(nameof(ListServiceBroker), database, "",
            () => queries.ListServiceBroker(database, cancellationToken));

    [McpServerTool, Description("List all user-defined CLR assemblies registered in the specified database.")]
    public Task<string> ListClrAssemblies(
        [Description("Name of the configured database")] string database,
        CancellationToken cancellationToken = default) =>
        audit.Invoke(nameof(ListClrAssemblies), database, "",
            () => queries.ListClrAssemblies(database, cancellationToken));
}
